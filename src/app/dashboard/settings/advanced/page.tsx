      ...
      >
        <div className="flex items-center space-x-3">
          {currentTab && (
            <>
              <div
                className={`p-2 rounded-lg bg-${currentTab.color}-100 dark:bg-${currentTab.color}-900/30`}
              >
                <currentTab.icon
                  className={`h-5 w-5 text-${currentTab.color}-600 dark:text-${currentTab.color}-400`}
                />
              </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base lg:text-lg max-w-2xl">
            ...
            <span className="hidden sm:inline">
              {" "}
              Ten cuidado, los cambios afectan a todos los usuarios.
            </span>
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-red-800 dark:text-red-200 mt-1">
                Los cambios realizados aquí afectan a todos los usuarios del
                sistema. Proceda con precaución y asegúrese de entender el
